...
public class UserFollowerRecyclerAdaptor extends RecyclerView.Adapter<UserFollowerRecyclerAdaptor.MyViewHolder>{

    private Context context;
    private List<Pair<User,String>> liu;

    public UserFollowerRecyclerAdaptor(Context context, List<Pair<User,String>> liu) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view=li.inflate(R.layout.user_follower_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Are you sure want to remove this user?");
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                pd.show();
                                DatabaseReference df = FirebaseDatabase.getInstance().getReference().child("Follower").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(p.second);
                                df.setValue(null).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            DatabaseReference dff = FirebaseDatabase.getInstance().getReference().child("Following").child(p.second).child(FirebaseAuth.getInstance().getCurrentUser().getUid());
